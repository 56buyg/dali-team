...
// Validate ../../app/(workbench)/tools/[toolId]/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/tools/[toolId]">> = Specific
  const handler = {} as typeof import("../../app/(workbench)/tools/[toolId]/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../app/api/tools/ai-video/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/tools/ai-video">> = Specific
  const handler = {} as typeof import("../../app/api/tools/ai-video/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../app/api/tools/image-to-image/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/tools/image-to-image">> = Specific
  const handler = {} as typeof import("../../app/api/tools/image-to-image/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../app/api/tools/image-upscaler/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/tools/image-upscaler">> = Specific
  const handler = {} as typeof import("../../app/api/tools/image-upscaler/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../app/api/tools/text-to-image/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/tools/text-to-image">> = Specific
  const handler = {} as typeof import("../../app/api/tools/text-to-image/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
